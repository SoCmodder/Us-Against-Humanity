                    ...
                    <div class="carousel-inner">
                            <div class="active item" data-slide-number="0">
                              <div class="new_html_code">
                                <h5 style="font-size:15px">Not giving a shit about the Third World.</h5><!--Implement card text here-->
                                <br>
                                <button class="btn btn-inverse">Play Card <i class="icon-plus-sign icon-white"></i></button>
                              </div>
                            </div>
                            <div class="item" data-slide-number="1"><img src="http://placehold.it/170x200&text=two" /></div>
                            <div class="item" data-slide-number="2"><img src="http://placehold.it/170x200&text=three" /></div>
                            <div class="item" data-slide-number="3"><img src="http://placehold.it/170x200&text=four" /></div>
                            <div class="item" data-slide-number="4"><img src="http://placehold.it/170x200&text=five" /></div>
                            <div class="item" data-slide-number="5"><img src="http://placehold.it/170x200&text=six" /></div>
                            <div class="item" data-slide-number="6"><img src="http://placehold.it/170x200&text=seven" /></div>
                            <div class="item" data-slide-number="7"><img src="http://placehold.it/170x200&text=eight" /></div>
                            <div class="item" data-slide-number="8"><img src="http://placehold.it/170x200&text=nine" /></div>
                            <div class="item" data-slide-number="9"><img src="http://placehold.it/170x200&text=ten" /></div>
                    </div>
                    <!-- Carousel nav -->
